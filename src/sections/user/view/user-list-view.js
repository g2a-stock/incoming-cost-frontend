...
const TABLE_HEAD = [
  ...
  { id: 'password', label: 'Пароль', width: 180 },
  { id: 'percentage', label: 'Процент', width: 220 },
  { id: 'description', label: 'Описание', width: 220 },
  { id: 'role', label: 'Роль', width: 180 },
  { id: 'active', label: 'Статус', width: 100 },
  { id: '', width: 88 },
];
...
function applyFilter({ inputData, comparator, filters }) {
  ...
  if (login) {
    inputData = inputData.filter(
      (user) => user.login.toLowerCase().indexOf(login.toLowerCase()) !== -1
    );
  }
